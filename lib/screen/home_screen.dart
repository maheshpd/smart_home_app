  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: const Icon(Icons.menu, color: Color(0xFF151515)),
        elevation: 0,
        actions: [
          Padding(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(
                icon: Icon(Icons.category_rounded), label: ("Device")),
            BottomNavigationBarItem(
              ...
              Row(
                children: [
                  _makeDeviceEl("Lighting", "subText", Icons.lightbulb_outline, size.width,
                      Switch(value: _switch1, onChanged: (bool e) {setState(() => _switch1 = e);},
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Icon(icon, size: 25.0, color: const Color(0xFF151515)),
                ),
              ),
            ),
            Align(
